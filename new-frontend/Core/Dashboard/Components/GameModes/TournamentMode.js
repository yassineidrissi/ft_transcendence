...
class TournamentMode extends HTMLElement {
    constructor() {
		...
		tournamentMode.className = "position-relative border";
        tournamentMode.innerHTML = `<div class="d-flex">
                <game-mode title="Tournament"></game-mode>
                <div class="d-flex">
                    <p>Prove your ping pong prowess in thrilling tournaments!<p>
                    <svg
                                width="80"
                                height="80"
                                viewBox="0 0 64 64"
